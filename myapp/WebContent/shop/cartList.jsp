	...
	<td align="center" bgcolor="#FFFFCC">
		<table width="95%" align="center" bgcolor="#FFFF99" border="1">
			...
			<%
				...
				if(hCart.isEmpty()){ //장바구니가 비버있음.
				%>
				<tr>
					<td colspan="5" align="center">장바구니에 아무것도 없지롱~</td>
				</tr>
				<%
				}else {
					//key값을 가져오기 위한
					...
					//hasMoreElements() : 요소값이 있으면 true 없으면 false
					while(hCartKey.hasMoreElements()) {
						//hCart에 저장된 주문 객체 리턴
						OrderBean order = hCart.get(hCartKey.nextElement());
						int ProductNo = order.getProductNo();
						//상품 객체 : 상품 가격, 이름을 가져오기 위함.
						...
						<tr align="center">
							<form method="post" action="cartProc.jsp">
								...
								<td><%=pName%></td>
								<td><input name="quantity" value="<%=quantity%>" size="5"> 개</td>
					...
					<tr>
						<td colspan="4" align="right">
							총 금액 : <%=UtilMgr.monFormat(totalPrice) %>원
						</td>
						<td align="center">
							<a href="orderProc.jsp">주문 하기</a>
						</td>
					</tr>
					<% } //if%>
		</table>
