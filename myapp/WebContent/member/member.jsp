					...
					<td bgcolor="#FFFFCC">
						<table border="1" cellspacing="0" cellpadding="2" width="600">
							...
							<tr>
								<td width="20%">아이디</td>
								<td width="50%">
									<input name="id" size="15" value="abc"> 
							...
							<tr>
								<td>이름</td>
								<td><input name="name" size="15" value="전민철">
								</td>
								<td>이름을 적어주세요.</td>
							</tr>
							<tr>
							...
							<tr>
								<td>생년월일</td>
								<td><input name="birthday" size="6" value="921006">
									ex)830815</td>
								<td>생년월일를 적어 주세요.</td>
							</tr>
							<tr>
								<td>Email</td>
								<td><input name="email" size="30" value="sc@naver.com">
								</td>
								<td>이메일를 적어 주세요.</td>
							</tr>
							<tr>
