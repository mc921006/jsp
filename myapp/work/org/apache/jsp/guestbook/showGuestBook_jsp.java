 ...
 * Generated at: 2019-04-24 07:13:43 UTC
...
public final class showGuestBook_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/guestbook/getSession.jsp", Long.valueOf(1555982645315L));
    _jspx_dependants.put("/guestbook/postGuestBook.jsp", Long.valueOf(1555917331785L));
  }
...
if(writer.getHp()==null || writer.getHp().equals("")){
      ...
      out.write("\"> <img alt=\"홈페이지\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tsrc=\"img/hp.bmp\" border=\"0\">\r\n");
      out.write("\t\t\t\t\t\t\t</a> ");
	} 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(bean.getRedate()+" "+bean.getRegtime() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
